...
let imgfacil = document.createElement('img')
imgfacil.src = './Imagenes/facil.png'
imgfacil.id = 'imgfacil'

let imgMedio = document.createElement('img')
imgMedio.src = './Imagenes/medio.png'
imgMedio.id = 'imgfacil'

let imgdificil = document.createElement('img')
imgdificil.src = './Imagenes/dificil.png'
imgdificil.id = 'imgfacil'

if (urlActual === "/comida.html") {
    ...
    document.getElementById("alertaPri").appendChild(facil)
    ...
    document.getElementById("alertaPri").appendChild(medio)
    ...
    document.getElementById("alertaPri").appendChild(dificil)
    function comF() {
